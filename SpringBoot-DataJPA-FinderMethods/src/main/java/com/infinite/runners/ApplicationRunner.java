...
public class ApplicationRunner implements org.springframework.boot.ApplicationRunner {
	...
	private void saveStudent() {
		Student st = new Student(null, "Jhon", 28,null, new Date());
		Student result = repository.save(st);
		System.out.println("Saved Employee is:: " + result);
	}

	private void saveAllStudent() {
		Student st1 = new Student(null, "Adams", 18,null, new Date("2002/12/12"));
		Student st2 = new Student(null, "Crist", 23,null, new Date("2009/01/10"));
		Student st3 = new Student(null, "Abhraham", 22,null, new Date("2005/10/12"));
